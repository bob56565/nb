...
function analyzeImageWithGPT4(imageData) {
    const apiKey = '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';
            ...
            messages: [
                {
                    ...
                    content: [
                        {
                            type: "text",
                            text: "Analyze this image and describe its contents in detail. If there's text visible, please read and interpret it. If it's a medical question or scenario, provide a detailed explanation or answer."
                        },
                        {
                            type: "image_url",
                            image_url: {
