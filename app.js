...
// Request access to the camera with back camera preference and auto focus/exposure adjustments
function startVideoStream() {
    const constraints = {
        video: {
            facingMode: { exact: "environment" }, // Explicitly request back camera
            focusMode: "continuous", // Continuous focus adjustment
...
// Start the video stream and text analysis process automatically
startVideoStream();
startTextAnalysis();
